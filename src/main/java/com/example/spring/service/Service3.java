...
public class Service3 {
    ...
    public void action20() {
        System.out.println("(((((((((((((((((((((((((((((((((");
        List<Entity18> list9 = entity18Repository.findByCountryInOrderBySupplierName(List.of("japan", "uk"));
        for (Entity18 entity18 : list9) {
            System.out.println(entity18);
        }
        System.out.println(")))))))))))))))))))))))))))))))))))");
        List<Entity18> list10 = entity18Repository.findBySupplierNameContainsOrderBySupplierNameDesc("er");
        for (Entity18 entity18 : list10) {
            System.out.println(entity18);
        }
    }
}