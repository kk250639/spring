...
public class Service2 {
    ...
    // 연습
    // entity11Repository.findById()를 사용해서 하나의 record르 조회하는
    // process8 메소드 작성
    ...
    public Entity15 process13(Integer id) {
        Optional<Entity15> data = entity15Repository.findById(id);
        if (data.isPresent()) {
            return data.get();
        }
        return null;
    ...
    public void process18(Integer id) {
//    Entity16 data = entity16Repository
    }
}