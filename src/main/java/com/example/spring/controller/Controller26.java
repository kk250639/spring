...
public class Controller26 {
    ...
    public String sub12() {
        List<OrderInfo> rs = service8.action12();

        for (OrderInfo orderInfo : rs) {
            System.out.println("entity41Info = " + orderInfo.getOrderDate());
            System.out.println("entity41Info = " + orderInfo.getProductName());
            System.out.println("entity41Info = " + orderInfo.getPrice());
            System.out.println("entity41Info = " + orderInfo.getQuantity());
            System.out.println("entity41Info = " + orderInfo.getCategoryName());
            System.out.println();
        }
        return "main26/sub12";
    }
