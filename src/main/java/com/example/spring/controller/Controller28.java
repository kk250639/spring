...
public class Controller28 {
    ...
    // 연습 : react에서 아래 메소드가 일할 수 있도록 8번째 메소드 만들고 클릭
    @GetMapping("sub9")
    public String sub9(String address, Integer score) {
    ...
    @GetMapping("sub10")
    public String sub10(String address, Integer score) {
        System.out.println("address = " + address);
        System.out.println("score = " + score);
    ...
    // 연습 : 아래 메소드가 일하도록 react에 12번쨰 버튼 만들고 클릭
    //      config params 활용
    @GetMapping("sub12")
